...
class PreservedBidirectionalAttention(nn.Module):
    ...
    def forward(self, k1, k2, preserved_k1, preserved_k2, v1, v2, k1_lengths=None, k2_lengths=None):
        ...
        score_1 = torch.bmm(preserved_k1, k2.transpose(1, 2))
        score_2 = torch.bmm(k1, preserved_k2.transpose(1, 2))
        ...
        w1 = self.softmax(score_1.transpose(1, 2))
        w2 = self.softmax(score_2)
